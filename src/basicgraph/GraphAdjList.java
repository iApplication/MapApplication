...
public class GraphAdjList extends Graph {
	...
	/** 
	 * XXX: Implement the abstract method for finding all 
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 List<Integer> listHop2 = new ArrayList<Integer>();
		 
		 List<Integer> neighborV = adjListsMap.get(v);
		 for(int i=0; i<neighborV.size(); ++i) {
			 
			 List<Integer> nodeI = adjListsMap.get(neighborV.get(i));
			 for(int j=0; j<nodeI.size(); ++j) {
				 listHop2.add(nodeI.get(j));
			 }
